...
switch ($item->browserNav) :
	default:
	case 0:
?><a <?php echo $class; echo $xattribs; echo $xhref; ?> <?php echo $title . $rel; ?>><?php echo $linktype; ?></a><?php
		break;
	case 1:
		// _blank
?><a <?php echo $class; echo $xattribs; echo $xhref; ?> target="_blank" <?php echo $title . $rel; ?>><?php echo $linktype; ?></a><?php
		break;
	case 2:
		// Use JavaScript "window.open"
		$options = 'toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=yes,' . $params->get('window_open');
			?><a <?php echo $class; echo $xhref;?> onclick="window.open(this.href,'targetWindow','<?php echo $options;?>');return false;" <?php echo $title; ?>><?php echo $linktype; ?></a><?php
		break;
endswitch;
