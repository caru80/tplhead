...
abstract class JHtmlJquery
{
	 ...
	 * @since   3.0
	 */
	public static function framework($noConflict = false, $debug = null, $migrate = false)
	{
		...
		JHtml::_('script', $templateDir.'/js/jquery.min.js', false, true, false, false, $debug);

		// Check if we are loading in noConflict
		if ($noConflict)
		{
			JHtml::_('script', $templateDir.'/js/jquery-noconflict.js', false, true, false, false, false);
		}

		// Check if we are loading Migrate
		if ($migrate)
		{
			JHtml::_('script', $templateDir.'/js/jquery-migrate.min.js', false, true, false, false, $debug);
		}
